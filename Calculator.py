...
entry1 = ctk.CTkEntry(root, width=100,height=60,font=("Arial",24))
entry1.grid(row=0, column=1, padx=5, pady=5)

entry2 = ctk.CTkEntry(root, width=100,height=60,font=("Arial",24))
...
minusbutton = ctk.CTkButton(root, fg_color="green", text="-", command=set_minus, font=("Arial", 16),width=75, height=60,)
minusbutton.grid(row=1, column=1)

multiplybutton = ctk.CTkButton(root, fg_color="green", text="*", command=set_multiply, font=("Arial", 16),width=75, height=60,)
multiplybutton.grid(row=1, column=2)

dividebutton = ctk.CTkButton(root, fg_color="green", text="/", command=set_division, font=("Arial", 16),width=75, height=60,)
